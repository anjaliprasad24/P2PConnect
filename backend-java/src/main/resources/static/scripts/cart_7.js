document.addEventListener('DOMContentLoaded', function() {
        ...
        cart.forEach(item => {
            ...
            <div class="item-image" style="width:80px;height:80px;text-align:center;display:flex;align-items:center;justify-content:center;font-size:2rem;">${item.image}</div>
