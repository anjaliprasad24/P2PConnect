document.addEventListener('DOMContentLoaded', function() {
        ...
        cart.forEach(item => {
            ...
            <img class="item-image" src="" alt="${item.name || 'Product image'}">
            ...
            const imgEl = itemElement.querySelector('.item-image');
            const rawImg = item.image || '';
            imgEl.src = rawImg ? (rawImg.startsWith('http') ? rawImg : BACKEND + rawImg) : PLACEHOLDER;
            // Quantity minus
